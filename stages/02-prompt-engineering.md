...
> 🦙 **Ollama 對照**：Few-shot 對小 model（gemma3:4b）改善幅度通常**更大**——小 model 更需要 example 來校準。改 SDK 跟練習 1 Path B 一樣。
...
> 🦙 **Ollama 對照**：CoT 對 gemma3:4b 等小 model **必要**——沒 step-by-step 幾乎答不對。可以拿這題實驗大 model 跟小 model 對 CoT 的依賴程度。
