...
### 📋 直接复制用的 5 个 Prompt（套到 Skills + CLAUDE.md 设计）

这 5 个原则**不是抽象的设计理论**——当你在 [Stage 5.3](05-claude-code-ecosystem.zh-Hans.md#53--skillsclaude-code-的行为层-claude-code-生态最关键的一层) 写 SKILL.md 或 [Stage 5.1](05-claude-code-ecosystem.zh-Hans.md#51--claude-code-基础) 写 CLAUDE.md 时、直接拿下面 prompt 丢给 Claude / Codex 就好。
...
#### Prompt 4 — 生成新的 CLAUDE.md（依 5 原则）
...
一次出 1 题、等我回答后给回馈、再出下一题。最后给总成绩。
```

→ **建议用法**：写 SKILL.md 前用 Prompt 3、写完用 Prompt 1 audit；写 CLAUDE.md 前用 Prompt 4、写完用 Prompt 2 audit；想确认自己懂概念用 Prompt 5。**这 5 个 prompt 就是 [Stage 5.1](05-claude-code-ecosystem.zh-Hans.md#51--claude-code-基础) + [Stage 5.3](05-claude-code-ecosystem.zh-Hans.md#53--skillsclaude-code-的行为层-claude-code-生态最关键的一层) 设计时的直接工具**。
