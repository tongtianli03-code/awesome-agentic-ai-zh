...
### 📋 直接複製用的 5 個 Prompt（套到 Skills + CLAUDE.md 設計）

這 5 個原則**不是抽象的設計理論**——當你在 [Stage 5.3](05-claude-code-ecosystem.md#53--skillsclaude-code-的行為層-claude-code-生態最關鍵的一層) 寫 SKILL.md 或 [Stage 5.1](05-claude-code-ecosystem.md#51--claude-code-基礎) 寫 CLAUDE.md 時、直接拿下面 prompt 丟給 Claude / Codex 就好。
...
#### Prompt 4 — 生成新的 CLAUDE.md（依 5 原則）
...
→ **建議用法**：寫 SKILL.md 前用 Prompt 3、寫完用 Prompt 1 audit；寫 CLAUDE.md 前用 Prompt 4、寫完用 Prompt 2 audit；想確認自己懂概念用 Prompt 5。**這 5 個 prompt 就是 [Stage 5.1](05-claude-code-ecosystem.md#51--claude-code-基礎) + [Stage 5.3](05-claude-code-ecosystem.md#53--skillsclaude-code-的行為層-claude-code-生態最關鍵的一層) 設計時的直接工具**。
