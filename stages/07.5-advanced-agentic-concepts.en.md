...
### 📋 5 ready-to-use prompts (apply these to Skills + CLAUDE.md design)

These 5 principles **are not abstract design theory** — when you write SKILL.md in [Stage 5.3](05-claude-code-ecosystem.en.md#53--skillsclaude-codes-behavior-layer--the-most-critical-layer-of-the-claude-code-ecosystem) or CLAUDE.md in [Stage 5.1](05-claude-code-ecosystem.en.md#51--claude-code-basics), just copy one of the prompts below into Claude / Codex.
...
#### Prompt 2 — Audit your existing CLAUDE.md
...
#### Prompt 3 — Generate a new SKILL.md (applying all 5 principles)
...
#### Prompt 4 — Generate a new CLAUDE.md (applying all 5 principles)
...
→ **Suggested usage**: use Prompt 3 before writing a SKILL.md and Prompt 1 to audit afterward; use Prompt 4 before writing CLAUDE.md and Prompt 2 to audit afterward; use Prompt 5 to verify you understand the concepts. **These 5 prompts are the direct tools for design decisions in [Stage 5.1](05-claude-code-ecosystem.en.md#51--claude-code-basics) + [Stage 5.3](05-claude-code-ecosystem.en.md#53--skillsclaude-codes-behavior-layer--the-most-critical-layer-of-the-claude-code-ecosystem)**.
